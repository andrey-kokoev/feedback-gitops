...
const ie = {}, St = [], Be = () => {
}, Si = () => !1, As = (e) => e.charCodeAt(0) === 111 && e.charCodeAt(1) === 110 && // uppercase letter
(e.charCodeAt(2) > 122 || e.charCodeAt(2) < 97), wn = (e) => e.startsWith("onUpdate:"), ue = Object.assign, xn = (e, t) => {
  const s = e.indexOf(t);
  s > -1 && e.splice(s, 1);
}, No = Object.prototype.hasOwnProperty, ee = (e, t) => No.call(e, t), H = Array.isArray, Ct = (e) => ss(e) === "[object Map]", Es = (e) => ss(e) === "[object Set]", Nn = (e) => ss(e) === "[object Date]", W = (e) => typeof e == "function", de = (e) => typeof e == "string", qe = (e) => typeof e == "symbol", ne = (e) => e !== null && typeof e == "object", Ci = (e) => (ne(e) || W(e)) && W(e.then) && W(e.catch), ki = Object.prototype.toString, ss = (e) => ki.call(e), Vo = (e) => ss(e).slice(8, -1), Ps = (e) => ss(e) === "[object Object]", Os = (e) => de(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, Vt = /* @__PURE__ */ bn(
...
), Ms = Is((e) => e.charAt(0).toUpperCase() + e.slice(1)), Bs = Is(
  (e) => e ? `on${Ms(e)}` : ""
), We = (e, t) => !Object.is(e, t), ds = (e, ...t) => {
...
function Bo(e) {
  const t = {};
  return e.replace(Wo, "").split(Uo).forEach((s) => {
    if (s) {
      const n = s.split(Ko);
...
const qo = "itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly", Yo = /* @__PURE__ */ bn(qo);
function Ai(e) {
  return !!e || e === "";
}
function Jo(e, t) {
...
const Ei = (e) => !!(e && e.__v_isRef === !0), K = (e) => de(e) ? e : e == null ? "" : H(e) || ne(e) && (e.toString === ki || !W(e.toString)) ? Ei(e) ? K(e.value) : JSON.stringify(e, Pi, 2) : String(e), Pi = (e, t) => Ei(t) ? Pi(e, t.value) : Ct(t) ? {
  [`Map(${t.size})`]: [...t.entries()].reduce(
    (s, [n, i], o) => (s[qs(n, o) + " =>"] = i, s),
    {}
  )
} : Es(t) ? {
  [`Set(${t.size})`]: [...t.values()].map((s) => qs(s))
} : qe(t) ? qs(t) : ne(t) && !H(t) && !Ps(t) ? String(t) : t, qs = (e, t = "") => {
  var s;
  return (
...
class Ri {
  ...
  run() {
    if (!(this.flags & 1))
      return this.fn();
    this.flags |= 2, zn(this), ji(this);
    const t = re, s = De;
    re = this, De = !0;
    try {
      return this.fn();
    } finally {
      Fi(this), re = t, De = s, this.flags &= -3;
    }
  }
  stop() {
    if (this.flags & 1) {
...
function Fi(e) {
  ...
  for (; n; ) {
    const i = n.prevDep;
    n.version === -1 ? (n === s && (s = i), _n(n), Qo(n)) : t = n, n.dep.activeLink = n.prevActiveLink, n.prevActiveLink = void 0, n = i;
  }
...
function Li(e) {
  if (e.flags & 4 && !(e.flags & 16) || (e.flags &= -17, e.globalVersion === Gt) || (e.globalVersion = Gt, !e.isSSR && e.flags & 128 && (!e.deps && !e._dirty || !on(e))))
    return;
  e.flags |= 2;
  const t = e.dep, s = re, n = De;
  re = e, De = !0;
  try {
    ji(e);
...
class Sn {
  ...
  track(t) {
    if (!re || !De || re === this.computed)
      return;
    let s = this.activeLink;
    if (s === void 0 || s.sub !== re)
      s = this.activeLink = new Zo(re, this), re.deps ? (s.prevDep = re.depsTail, re.depsTail.nextDep = s, re.depsTail = s) : re.deps = re.depsTail = s, Vi(s);
...
const ms = /* @__PURE__ */ new WeakMap(), gt = /* @__PURE__ */ Symbol(
  ""
), rn = /* @__PURE__ */ Symbol(
  ""
), Xt = /* @__PURE__ */ Symbol(
...
function we(e, t, s) {
  if (De && re) {
    ...
    let i = n.get(s);
    i || (n.set(s, i = new Sn()), i.map = n, i.key = s), i.track();
  }
}
function et(e, t, s, n, i, o) {
  ...
  if (vn(), t === "clear")
    ...
    const c = H(e), u = c && Os(s);
    if (c && s === "length") {
      const a = Number(n);
      r.forEach((p, _) => {
        (_ === "length" || _ === Xt || !qe(_) && _ >= a) && l(p);
      });
    } else
      switch ((s !== void 0 || r.has(void 0)) && l(r.get(s)), u && l(r.get(Xt)), t) {
        case "add":
          c ? u && l(r.get("length")) : (l(r.get(gt)), Ct(e) && l(r.get(rn)));
          break;
        case "delete":
          c || (l(r.get(gt)), Ct(e) && l(r.get(rn)));
          break;
        case "set":
          Ct(e) && l(r.get(gt));
          break;
...
function vt(e) {
  ...
  return t === e ? t : (we(t, "iterate", Xt), /* @__PURE__ */ Me(e) ? t : t.map(je));
}
function Ds(e) {
  return we(e = /* @__PURE__ */ Z(e), "iterate", Xt), e;
}
function Ue(e, t) {
  return /* @__PURE__ */ ot(e) ? Pt(/* @__PURE__ */ st(e) ? je(t) : t) : je(t);
}
const tr = {
  __proto__: null,
  [Symbol.iterator]() {
...
function Xe(e, t, s, n, i, o) {
  const r = Ds(e), l = r !== e && !/* @__PURE__ */ Me(e), c = r[t];
  if (c !== sr[t]) {
    const p = c.apply(e, o);
    return l ? je(p) : p;
  }
  let u = s;
  r !== e && (l ? u = function(p, _) {
    return s.call(this, Ue(e, p), _, e);
  } : s.length > 2 && (u = function(p, _) {
    return s.call(this, p, _, e);
  }));
  const a = c.call(r, u, n);
  return l && i ? i(a) : a;
}
function Un(e, t, s, n) {
  const i = Ds(e), o = i !== e && !/* @__PURE__ */ Me(e);
  let r = s, l = !1;
  i !== e && (o ? (l = n.length === 0, r = function(u, a, p) {
    return l && (l = !1, u = Ue(e, u)), s.call(this, u, Ue(e, a), p, e);
  }) : s.length > 3 && (r = function(u, a, p) {
    return s.call(this, u, a, p, e);
  }));
  const c = i[t](r, ...n);
  return l ? Ue(e, c) : c;
}
function Gs(e, t, s) {
  ...
  we(n, "iterate", Xt);
  const i = n[t](...s);
  return (i === -1 || i === !1) && /* @__PURE__ */ Fs(s[0]) ? (s[0] = /* @__PURE__ */ Z(s[0]), n[t](...s)) : i;
}
function jt(e, t, s = []) {
  nt(), vn();
...
const nr = /* @__PURE__ */ bn("__proto__,__v_isRef,__isVue"), Hi = new Set(
...
class zi {
  ...
  get(t, s, n) {
    ...
    if (s === "__v_isShallow")
      return o;
    if (s === "__v_raw")
      return n === (i ? o ? hr : Bi : o ? Wi : Ki).get(t) || // receiver is not the reactive proxy, but has the same prototype
    ...
    if ((qe(s) ? Hi.has(s) : nr(s)) || (i || we(t, "get", s), o))
      return l;
    if (/* @__PURE__ */ ae(l)) {
      const c = r && Os(s) ? l : l.value;
      return i && ne(c) ? /* @__PURE__ */ cn(c) : c;
    }
    return ne(l) ? i ? /* @__PURE__ */ cn(l) : /* @__PURE__ */ js(l) : l;
  }
}
class Ui extends zi {
  constructor(t = !1) {
  ...
  set(t, s, n, i) {
    ...
    const r = H(t) && Os(s);
    if (!this._isShallow) {
      const u = /* @__PURE__ */ ot(o);
      if (!/* @__PURE__ */ Me(n) && !/* @__PURE__ */ ot(n) && (o = /* @__PURE__ */ Z(o), n = /* @__PURE__ */ Z(n)), !r && /* @__PURE__ */ ae(o) && !/* @__PURE__ */ ae(n))
        return u || (o.value = n), !0;
    }
    const l = r ? Number(s) < t.length : ee(t, s), c = Reflect.set(
      t,
      s,
      n,
      /* @__PURE__ */ ae(t) ? t : i
    );
    return t === /* @__PURE__ */ Z(i) && (l ? We(n, o) && et(t, "set", s, n) : et(t, "add", s, n)), c;
  }
  deleteProperty(t, s) {
    const n = ee(t, s);
    t[s];
  ...
  has(t, s) {
    ...
    return (!qe(s) || !Hi.has(s)) && we(t, "has", s), n;
  }
  ownKeys(t) {
    return we(
      t,
...
const rr = /* @__PURE__ */ new Ui(), lr = /* @__PURE__ */ new or(), cr = /* @__PURE__ */ new Ui(!0);
const ln = (e) => e, cs = (e) => Reflect.getPrototypeOf(e);
function fr(e, t, s) {
  return function(...n) {
    const i = this.__v_raw, o = /* @__PURE__ */ Z(i), r = Ct(o), l = e === "entries" || e === Symbol.iterator && r, c = e === "keys" && r, u = i[e](...n), a = s ? ln : t ? Pt : je;
    return !t && we(
      o,
      "iterate",
      c ? rn : gt
...
function ar(e, t) {
  const s = {
    get(i) {
      ...
      e || (We(i, l) && we(r, "get", i), we(r, "get", l));
      const { has: c } = cs(r), u = t ? ln : e ? Pt : je;
      if (c.call(r, i))
        return u(o.get(i));
      if (c.call(r, l))
        return u(o.get(l));
    ...
    get size() {
      ...
      return !e && we(/* @__PURE__ */ Z(i), "iterate", gt), i.size;
    },
    has(i) {
      const o = this.__v_raw, r = /* @__PURE__ */ Z(o), l = /* @__PURE__ */ Z(i);
      return e || (We(i, l) && we(r, "has", i), we(r, "has", l)), i === l ? o.has(i) : o.has(i) || o.has(l);
    },
    forEach(i, o) {
      const r = this, l = r.__v_raw, c = /* @__PURE__ */ Z(l), u = t ? ln : e ? Pt : je;
      return !e && we(c, "iterate", gt), l.forEach((a, p) => i.call(o, u(a), u(p), r));
    }
  };
  return ue(
    s,
    e ? {
      ...
      add(i) {
        const o = /* @__PURE__ */ Z(this), r = cs(o), l = /* @__PURE__ */ Z(i), c = !t && !/* @__PURE__ */ Me(i) && !/* @__PURE__ */ ot(i) ? l : i;
        return r.has.call(o, c) || We(i, c) && r.has.call(o, i) || We(l, c) && r.has.call(o, l) || (o.add(c), et(o, "add", c, c)), this;
      },
      set(i, o) {
        !t && !/* @__PURE__ */ Me(o) && !/* @__PURE__ */ ot(o) && (o = /* @__PURE__ */ Z(o));
        const r = /* @__PURE__ */ Z(this), { has: l, get: c } = cs(r);
        let u = l.call(r, i);
        u || (i = /* @__PURE__ */ Z(i), u = l.call(r, i));
        const a = c.call(r, i);
        return r.set(i, o), u ? We(o, a) && et(r, "set", i, o) : et(r, "add", i, o), this;
      },
      delete(i) {
        ...
        const u = o.delete(i);
        return c && et(o, "delete", i, void 0), u;
      },
      clear() {
...
const Ki = /* @__PURE__ */ new WeakMap(), Wi = /* @__PURE__ */ new WeakMap(), Bi = /* @__PURE__ */ new WeakMap(), hr = /* @__PURE__ */ new WeakMap();
function mr(e) {
  switch (e) {
    case "Object":
    case "Array":
...
function gr(e) {
  return e.__v_skip || !Object.isExtensible(e) ? 0 : mr(Vo(e));
}
// @__NO_SIDE_EFFECTS__
function js(e) {
  return /* @__PURE__ */ ot(e) ? e : kn(
    e,
    !1,
    rr,
    ur,
...
// @__NO_SIDE_EFFECTS__
function st(e) {
  return /* @__PURE__ */ ot(e) ? /* @__PURE__ */ st(e.__v_raw) : !!(e && e.__v_isReactive);
}
// @__NO_SIDE_EFFECTS__
function ot(e) {
...
function Tn(e) {
  return !ee(e, "__v_skip") && Object.isExtensible(e) && Ti(e, "__v_skip", !0), e;
}
const je = (e) => ne(e) ? /* @__PURE__ */ js(e) : e, Pt = (e) => ne(e) ? /* @__PURE__ */ cn(e) : e;
// @__NO_SIDE_EFFECTS__
function ae(e) {
...
function wr(e, t) {
  return /* @__PURE__ */ ae(e) ? e : new xr(e, t);
}
class xr {
  constructor(t, s) {
    this.dep = new Sn(), this.__v_isRef = !0, this.__v_isShallow = !1, this._rawValue = s ? t : /* @__PURE__ */ Z(t), this._value = s ? t : je(t), this.__v_isShallow = s;
  }
  get value() {
    return this.dep.track(), this._value;
  }
  set value(t) {
    const s = this._rawValue, n = this.__v_isShallow || /* @__PURE__ */ Me(t) || /* @__PURE__ */ ot(t);
    t = n ? t : /* @__PURE__ */ Z(t), We(t, s) && (this._rawValue = t, this._value = n ? t : je(t), this.dep.trigger());
  }
}
function b(e) {
...
const vr = {
  ...
  set: (e, t, s, n) => {
    const i = e[t];
    return /* @__PURE__ */ ae(i) && !/* @__PURE__ */ ae(s) ? (i.value = s, !0) : Reflect.set(e, t, s, n);
  }
};
function qi(e) {
  return /* @__PURE__ */ st(e) ? e : new Proxy(e, vr);
}
// @__NO_SIDE_EFFECTS__
function yr(e) {
...
class Cr {
  constructor(t, s, n) {
    this.fn = t, this.setter = s, this._value = void 0, this.dep = new Sn(this), this.__v_isRef = !0, this.deps = void 0, this.depsTail = void 0, this.flags = 16, this.globalVersion = Gt - 1, this.next = void 0, this.effect = this, this.__v_isReadonly = !s, this.isSSR = n;
  }
  /**
   * @internal
   */
...
function kr(e, t, s = !1) {
  let n, i;
  return W(e) ? n = e : (n = e.get, i = e.set), new Cr(n, i, s);
}
const as = {}, gs = /* @__PURE__ */ new WeakMap();
let ht;
function Tr(e, t = !1, s = ht) {
  if (s) {
    let n = gs.get(s);
    n || gs.set(s, n = []), n.push(e);
  }
}
function Ar(e, t, s = ie) {
  const { immediate: n, deep: i, once: o, scheduler: r, augmentJob: l, call: c } = s, u = ($) => i ? $ : /* @__PURE__ */ Me($) || i === !1 || i === 0 ? tt($, 1) : tt($);
  let a, p, _, C, P = !1, m = !1;
  if (/* @__PURE__ */ ae(e) ? (p = () => e.value, P = /* @__PURE__ */ Me(e)) : /* @__PURE__ */ st(e) ? (p = () => u(e), P = !0) : H(e) ? (m = !0, P = e.some(($) => /* @__PURE__ */ st($) || /* @__PURE__ */ Me($)), p = () => e.map(($) => {
    if (/* @__PURE__ */ ae($))
      return $.value;
    if (/* @__PURE__ */ st($))
      return u($);
  ...
  const T = Mi(), G = () => {
    a.stop(), T && T.active && xn(T.effects, a);
  };
  if (o && t) {
    const $ = t;
    t = (...J) => {
  ...
  let B = m ? new Array(e.length).fill(as) : as;
  const X = ($) => {
    if (!(!(a.flags & 1) || !a.dirty && !$))
      if (t) {
        const J = a.run();
        if (i || P || (m ? J.some((ve, fe) => We(ve, B[fe])) : We(J, B))) {
          _ && _();
          const ve = ht;
          ht = a;
          try {
  ...
  return l && l(X), a = new Ri(p), a.scheduler = r ? () => r(X, !1) : X, C = ($) => Tr($, !1, a), _ = a.onStop = () => {
    const $ = gs.get(a);
    if ($) {
      if (c)
        c($, 4);
  ...
  }, t ? n ? X(!0) : B = a.run() : r ? r(X.bind(null, !0), !0) : a.run(), G.pause = a.pause.bind(a), G.resume = a.resume.bind(a), G.stop = G, G;
}
function tt(e, t = 1 / 0, s) {
  ...
  if (s.set(e, t), t--, /* @__PURE__ */ ae(e))
    ...
    for (const n of Object.getOwnPropertySymbols(e))
      Object.prototype.propertyIsEnumerable.call(e, n) && tt(e[n], t, s);
  }
  return e;
}
/**
...
function Ls(e, t, s, n = !0) {
  const i = t ? t.vnode : null, { errorHandler: o, throwUnhandledErrorInProduction: r } = t && t.appContext.config || ie;
  if (t) {
    let l = t.parent;
...
function Pr(e) {
  let t = ze + 1, s = Se.length;
  for (; t < s; ) {
    const n = t + s >>> 1, i = Se[n], o = Qt(i);
...
function An(e) {
  if (!(e.flags & 1)) {
    const t = Qt(e), s = Se[Se.length - 1];
    !s || // fast path when the job id is larger than the tail
    !(e.flags & 2) && t >= Qt(s) ? Se.push(e) : Se.splice(Pr(t), 0, e), e.flags |= 1, Ji();
  }
}
function Ji() {
  bs || (bs = Yi.then(Xi));
...
function Or(e) {
  H(e) ? kt.push(...e) : ct && e.id === -1 ? ct.splice(_t + 1, 0, e) : e.flags & 1 || (kt.push(e), e.flags |= 1), Ji();
}
function Kn(e, t, s = ze + 1) {
  for (; s < Se.length; s++) {
    const n = Se[s];
    if (n && n.flags & 2) {
      if (e && n.id !== e.uid)
...
function Xi(e) {
  try {
    ...
    ze = -1, Se.length = 0, Gi(), bs = null, (Se.length || kt.length) && Xi();
  }
}
let Oe = null, Qi = null;
function ws(e) {
  const t = Oe;
  return Oe = e, Qi = e && e.type.__scopeId || null, t;
}
function Ir(e, t = Oe, s) {
  if (!t || e._n)
    return e;
  const n = (...i) => {
    n._d && si(-1);
...
function bt(e, t, s = !1) {
  const n = To();
  if (n || wt) {
    let i = wt ? wt._context.provides : n ? n.parent == null || n.ce ? n.vnode.appContext && n.vnode.appContext.provides : n.parent.provides : void 0;
    if (i && e in i)
      return i[e];
...
const $r = /* @__PURE__ */ Symbol.for("v-scx"), Dr = () => bt($r);
function Tt(e, t, s) {
  return Zi(e, t, s);
}
function Zi(e, t, s = ie) {
  const { immediate: n, deep: i, flush: o, once: r } = s, l = ue({}, s), c = t && n || !t && o !== "post";
  let u;
  if (es) {
    if (o === "sync") {
      const C = Dr();
  ...
  const a = xe;
  l.call = (C, P, m) => Ye(C, a, P, m);
  let p = !1;
  o === "post" ? l.scheduler = (C) => {
    Ae(C, a && a.suspense);
  } : o !== "sync" && (p = !0, l.scheduler = (C, P) => {
    P ? C() : An(C);
  }), l.augmentJob = (C) => {
    t && (C.flags |= 4), p && (C.flags |= 2, a && (C.id = a.uid, C.i = a));
  };
  const _ = Ar(e, t, l);
  return es && (u ? u.push(_) : c && _()), _;
}
function jr(e, t, s) {
  const n = this.proxy, i = de(e) ? e.includes(".") ? eo(n, e) : () => n[e] : e.bind(n, n);
  let o;
  W(t) ? o = t : (o = t.handler, s = t);
  const r = os(this), l = Zi(i, o.bind(n), s);
  return r(), l;
}
function eo(e, t) {
  const s = t.split(".");
...
const Fr = /* @__PURE__ */ Symbol("_vte"), Lr = (e) => e.__isTeleport, Nr = /* @__PURE__ */ Symbol("_leaveCb");
function En(e, t) {
...
function Ut(e, t, s, n, i = !1) {
  ...
  const o = n.shapeFlag & 4 ? Us(n.component) : n.el, r = i ? null : o, { i: l, r: c } = e, u = t && t.r, a = l.refs === ie ? l.refs = {} : l.refs, p = l.setupState, _ = /* @__PURE__ */ Z(p), C = p === ie ? Si : (m) => Wn(a, m) ? !1 : ee(_, m), P = (m, T) => !(T && Wn(a, T));
  if (u != null && u !== c) {
    if (Bn(t), de(u))
      a[u] = null, C(u) && (p[u] = null);
    else if (/* @__PURE__ */ ae(u)) {
      const m = t;
      P(u, m.k) && (u.value = null), m.k && (a[m.k] = null);
    }
  }
  if (W(c))
    is(c, l, 12, [r, a]);
  else {
    const m = de(c), T = /* @__PURE__ */ ae(c);
    if (m || T) {
      const G = () => {
        if (e.f) {
          const B = m ? C(c) ? p[c] : a[c] : P() || !e.k ? c.value : a[e.k];
          if (i)
            H(B) && xn(B, o);
          else if (H(B))
            ...
            const X = [o];
            P(c, e.k) && (c.value = X), e.k && (a[e.k] = X);
          }
        } else m ? (a[c] = r, C(c) && (p[c] = r)) : T && (P(c, e.k) && (c.value = r), e.k && (a[e.k] = r));
      };
      if (r) {
        const B = () => {
          G(), xs.delete(e);
        };
        B.id = -1, xs.set(e, B), Ae(B, s);
      } else
        Bn(e), G();
    }
  }
...
function no(e, t, s = xe) {
  ...
  if (Ns(t, n, s), s) {
    let i = s.parent;
    for (; i && i.parent; )
      so(i.parent.vnode) && zr(n, t, s, i), i = i.parent;
  }
}
function zr(e, t, s, n) {
  const i = Ns(
...
function Ns(e, t, s = xe, n = !1) {
  if (s) {
    const i = s[e] || (s[e] = []), o = t.__weh || (t.__weh = (...r) => {
      nt();
      const l = os(s), c = Ye(t, s, e, r);
      return l(), it(), c;
    });
...
const rt = (e) => (t, s = xe) => {
  (!es || e === "sp") && Ns(e, (...n) => t(...n), s);
}, Ur = rt("bm"), Vs = rt("m"), Kr = rt(
  "bu"
), Wr = rt("u"), Br = rt(
  "bum"
), Pn = rt("um"), qr = rt(
...
const Xr = "components";
function Qr(e, t) {
  return el(Xr, e, !0, t) || e;
}
const Zr = /* @__PURE__ */ Symbol.for("v-ndc");
function el(e, t, s = !0, n = !1) {
  const i = Oe || xe;
  if (i) {
    const o = i.type;
    {
      ...
      if (l && (l === t || l === me(t) || l === Ms(me(t))))
        return o;
    }
    const r = (
      // local registration
      // check instance[type] first which is resolved for options API
      qn(i[e] || o[e], t) || // global registration
      qn(i.appContext[e], t)
    );
    return !r && n ? o : r;
  }
...
function Re(e, t, s, n) {
  ...
  if (r || de(e)) {
    ...
    let c = !1, u = !1;
    l && (c = !/* @__PURE__ */ Me(e), u = /* @__PURE__ */ ot(e), e = Ds(e)), i = new Array(e.length);
    for (let a = 0, p = e.length; a < p; a++)
      i[a] = t(
        c ? u ? Pt(je(e[a])) : je(e[a]) : e[a],
        a,
        void 0,
        o
      );
...
const fn = (e) => e ? Ao(e) ? Us(e) : fn(e.parent) : null, Wt = (
...
), Xs = (e, t) => e !== ie && !e.__isScriptSetup && ee(e, t), tl = {
  get({ _: e }, t) {
    if (t === "__v_skip")
      return !0;
  ...
  set({ _: e }, t, s) {
    ...
    return Xs(i, t) ? (i[t] = s, !0) : n !== ie && ee(n, t) ? (n[t] = s, !0) : ee(e.props, t) || t[0] === "$" && t.slice(1) in e ? !1 : (o[t] = s, !0);
  },
  has({
    _: { data: e, setupState: t, accessCache: s, ctx: n, appContext: i, props: o, type: r }
  }, l) {
    let c;
    return !!(s[l] || e !== ie && l[0] !== "$" && ee(e, l) || Xs(t, l) || ee(o, l) || ee(n, l) || ee(Wt, l) || ee(i.config.globalProperties, l) || (c = r.__cssModules) && c[l]);
  },
  defineProperty(e, t, s) {
    return s.get != null ? e._.accessCache[t] = 0 : ee(s, "value") && this.set(e, t, s.value, null), Reflect.defineProperty(e, t, s);
  }
};
function Yn(e) {
  return H(e) ? e.reduce(
...
function sl(e) {
  ...
  if (i) {
    const D = i.call(s, s);
    ne(D) && (e.data = /* @__PURE__ */ js(D));
  }
  if (an = !0, o)
    for (const D in o) {
      const F = o[D], Ge = W(F) ? F.bind(s, s) : W(F.get) ? F.get.bind(s, s) : Be, rs = !W(F) && W(F.set) ? F.set.bind(s) : Be, ut = be({
        get: Ge,
        set: rs
      });
  ...
  a && Jn(a, e, "c");
  function x(D, F) {
    H(F) ? F.forEach((Ge) => D(Ge.bind(s))) : F && D(F.bind(s));
  }
  if (x(Ur, p), x(Vs, _), x(Kr, C), x(Wr, P), x(Vr, m), x(Hr, T), x(Gr, Y), x(Jr, ve), x(Yr, fe), x(Br, B), x(Pn, $), x(qr, I), H(A))
    if (A.length) {
  ...
  J && e.render === Be && (e.render = J), ce != null && (e.inheritAttrs = ce), he && (e.components = he), R && (e.directives = R), I && to(e);
}
function nl(e, t, s = Be) {
  H(e) && (e = un(e));
  for (const n in e) {
    const i = e[n];
    let o;
    ne(i) ? "default" in i ? o = bt(
      i.from || n,
      i.default,
      !0
    ) : o = bt(i.from || n) : o = bt(i), /* @__PURE__ */ ae(o) ? Object.defineProperty(t, n, {
      enumerable: !0,
      configurable: !0,
      get: () => o.value,
      set: (r) => o.value = r
...
function oo(e) {
  ...
  return l ? c = l : !i.length && !s && !n ? c = t : (c = {}, i.length && i.forEach(
    (u) => vs(c, u, r, !0)
  ), vs(c, t, r)), ne(t) && o.set(t, c), c;
}
function vs(e, t, s, n = !1) {
  const { mixins: i, extends: o } = t;
  o && vs(e, o, s, !0), i && i.forEach(
    (r) => vs(e, r, s, !0)
  );
  for (const r in t)
    if (!(n && r === "expose")) {
...
function Xn(e, t) {
  return e ? H(e) && H(t) ? [.../* @__PURE__ */ new Set([...e, ...t])] : ue(
...
function cl(e, t) {
  return function(n, i = null) {
    ...
    const u = o.app = {
      ...
      use(a, ...p) {
        return r.has(a) || (a && W(a.install) ? (r.add(a), a.install(u, ...p)) : W(a) && (r.add(a), a(u, ...p))), u;
      },
      mixin(a) {
      ...
      mount(a, p, _) {
        if (!c) {
          const C = u._ceVNode || Ce(n, i);
          return C.appContext = o, _ === !0 ? _ = "svg" : _ === !1 && (_ = void 0), e(C, a, _), c = !0, u._container = a, a.__vue_app__ = u, Us(C.component);
        }
      },
      onUnmount(a) {
        l.push(a);
...
let wt = null;
const fl = (e, t) => t === "modelValue" || t === "model-value" ? e.modelModifiers : e[`${t}Modifiers`] || e[`${me(t)}Modifiers`] || e[`${Pe(t)}Modifiers`];
function al(e, t, ...s) {
  if (e.isUnmounted) return;
  const n = e.vnode.props || ie;
  let i = s;
  const o = t.startsWith("update:"), r = o && fl(n, t.slice(7));
  r && (r.trim && (i = s.map((a) => de(a) ? a.trim() : a)), r.number && (i = s.map(Rs)));
  let l, c = n[l = Bs(t)] || // also try camelCase event handler (#2249)
  n[l = Bs(me(t))];
  !c && o && (c = n[l = Bs(Pe(t))]), c && Ye(
    c,
    e,
    6,
    i
...
function lo(e, t, s = !1) {
  ...
  return !o && !l ? (ne(e) && n.set(e, null), null) : (H(o) ? o.forEach((c) => r[c] = null) : ue(r, o), ne(e) && n.set(e, r), r);
}
function Hs(e, t) {
  return !e || !As(t) ? !1 : (t = t.slice(2).replace(/Once$/, ""), ee(e, t[0].toLowerCase() + t.slice(1)) || ee(e, Pe(t)) || ee(e, t));
}
function Qn(e) {
  const {
    type: t,
  ...
  try {
    ...
    Bt.length = 0, Ls($, e, 1), G = Ce(ft);
  }
  let X = G;
  if (B && m !== !1) {
    const $ = Object.keys(B), { shapeFlag: J } = X;
    $.length && J & 7 && (o && $.some(wn) && (B = pl(
      B,
      o
    )), X = Ot(X, B, !1, !0));
  }
  return s.dirs && (X = Ot(X, null, !1, !0), X.dirs = X.dirs ? X.dirs.concat(s.dirs) : s.dirs), s.transition && En(X, s.transition), G = X, ws(T), G;
}
const dl = (e) => {
  let t;
  for (const s in e)
  ...
  const s = {};
  for (const n in e)
    (!wn(n) || !(n.slice(9) in t)) && (s[n] = e[n]);
  return s;
};
function hl(e, t, s) {
  const { props: n, children: i, component: o } = e, { props: r, children: l, patchFlag: c } = t, u = o.emitsOptions;
  ...
  if (s && c >= 0) {
    ...
    return (i || l) && (!l || !l.$stable) ? !0 : n === r ? !1 : n ? r ? Zn(n, r, u) : !0 : !!r;
  return !1;
}
function Zn(e, t, s) {
...
function co(e, t, s) {
  const n = e[s], i = t[s];
  return s === "style" && ne(n) && ne(i) ? !ns(n, i) : n !== i;
}
...
const fo = {}, ao = () => Object.create(fo), uo = (e) => Object.getPrototypeOf(e) === fo;
function gl(e, t, s, n = !1) {
  const i = {}, o = ao();
  e.propsDefaults = /* @__PURE__ */ Object.create(null), po(e, t, i, o);
  for (const r in e.propsOptions[0])
    r in i || (i[r] = void 0);
  s ? e.props = n ? i : /* @__PURE__ */ br(i) : e.type.props ? e.props = i : e.props = o, e.attrs = o;
}
function bl(e, t, s, n) {
  const {
    props: i,
  ...
  if (
    ...
    for (const p in l)
      ...
      ((a = Pe(p)) === p || !ee(t, a))) && (c ? s && // for camelCase
...
function po(e, t, s, n) {
  ...
  if (t)
    for (let c in t) {
      ...
      const u = t[c];
      let a;
      i && ee(i, a = me(c)) ? !o || !o.includes(a) ? s[a] = u : (l || (l = {}))[a] = u : Hs(e.emitsOptions, c) || (!(c in n) || u !== n[c]) && (n[c] = u, r = !0);
    }
  if (o) {
    const c = /* @__PURE__ */ Z(s), u = l || ie;
...
function dn(e, t, s, n, i, o) {
  ...
  if (r != null) {
    ...
    if (l && n === void 0) {
      const c = r.default;
      if (r.type !== Function && !r.skipFactory && W(c)) {
...
function ho(e, t, s = !1) {
  ...
  if (H(o))
    ...
    for (const a in o) {
      const p = me(a);
      if (ei(p)) {
        const _ = o[a], C = r[p] = H(_) || W(_) ? { type: _ } : ue({}, _), P = C.type;
        let m = !1, T = !0;
        if (H(P))
          for (let G = 0; G < P.length; ++G) {
            const B = P[G], X = W(B) && B.name;
            if (X === "Boolean") {
              m = !0;
              break;
            } else X === "String" && (T = !1);
...
const On = (e) => e === "_" || e === "_ctx" || e === "$stable", In = (e) => H(e) ? e.map(Ke) : [Ke(e)], xl = (e, t, s) => {
  if (t._n)
    return t;
  const n = Ir((...i) => In(t(...i)), s);
  return n._c = !1, n;
}, mo = (e, t, s) => {
  const n = e._ctx;
  for (const i in e) {
  ...
  if (e.vnode.shapeFlag & 32) {
    const i = t._;
    i ? (bo(n, t, s), s && Ti(n, "_", i, !0)) : mo(t, n);
  } else t && go(e, t);
}, yl = (e, t, s) => {
  ...
  if (n.shapeFlag & 32) {
    const l = t._;
    l ? s && l === 1 ? o = !1 : bo(i, t, s) : (o = !t.$stable, mo(t, i)), r = t;
  } else t && (go(e, t), r = { default: 1 });
  if (o)
    for (const l in i)
      !On(l) && r[l] == null && delete i[l];
}, Ae = Tl;
function _l(e) {
  return Sl(e);
}
function Sl(e, t) {
  ...
  const {
  ...
  } = e, m = (f, d, g, S = null, w = null, v = null, O = void 0, E = null, k = !!d.dynamicChildren) => {
    if (f === d)
      return;
    f && !Ft(f, d) && (S = ls(f), Fe(f, w, v, !0), f = null), d.patchFlag === -2 && (k = !1, d.dynamicChildren = null);
    const { type: y, ref: V, shapeFlag: M } = d;
    switch (y) {
      case zs:
        T(f, d, g, S);
        break;
    ...
    V != null && w ? Ut(V, f && f.ref, v, d || f, !d) : V == null && f && f.ref != null && Ut(f.ref, null, v, f, !0);
  }, T = (f, d, g, S) => {
    if (f == null)
      n(
        d.el = l(d.children),
    ...
    let k, y;
    const { props: V, shapeFlag: M, transition: L, dirs: z } = f;
    if (k = f.el = r(
      f.type,
      v,
      V && V.is,
      V
    ), M & 8 ? a(k, f.children) : M & 16 && Y(
      f.children,
      k,
      null,
      S,
      ...
      O,
      E
    ), z && dt(f, null, S, "created"), fe(k, f, f.scopeId, O, S), V) {
      for (const oe in V)
        oe !== "value" && !Vt(oe) && o(k, oe, null, V[oe], v, S);
      "value" in V && o(k, "value", null, V.value, v), (y = V.onVnodeBeforeMount) && He(y, S, f);
    }
    z && dt(f, null, S, "beforeMount");
    const Q = Cl(w, L);
    Q && L.beforeEnter(k), n(k, d, g), ((y = V && V.onVnodeMounted) || Q || z) && Ae(() => {
      y && He(y, S, f), Q && L.enter(k), z && dt(f, null, S, "mounted");
    }, w);
  }, fe = (f, d, g, S, w) => {
    if (g && C(f, g), S)
    ...
    if (w) {
      let v = w.subTree;
      if (d === v || yo(v.type) && (v.ssContent === d || v.ssFallback === d)) {
        const O = w.vnode;
        fe(
          f,
          O,
  ...
  }, Y = (f, d, g, S, w, v, O, E, k = 0) => {
    for (let y = k; y < f.length; y++) {
      const V = f[y] = E ? Ze(f[y]) : Ke(f[y]);
      m(
        null,
        V,
        d,
    ...
    k |= f.patchFlag & 16;
    const M = f.props || ie, L = d.props || ie;
    let z;
    if (g && pt(g, !1), (z = L.onVnodeBeforeUpdate) && He(z, g, d, f), V && dt(d, f, g, "beforeUpdate"), g && pt(g, !0), (M.innerHTML && L.innerHTML == null || M.textContent && L.textContent == null) && a(E, ""), y ? A(
      f.dynamicChildren,
      y,
      E,
      g,
      ...
      if (k & 16)
        ce(E, M, L, g, w);
      else if (k & 2 && M.class !== L.class && o(E, "class", null, L.class, w), k & 4 && o(E, "style", M.style, L.style, w), k & 8) {
        const Q = d.dynamicProps;
        for (let oe = 0; oe < Q.length; oe++) {
          const te = Q[oe], ke = M[te], Te = L[te];
          (Te !== ke || te === "value") && o(E, te, ke, Te, w, g);
        }
      }
      k & 1 && f.children !== d.children && a(E, d.children);
    } else !O && y == null && ce(E, M, L, g, w);
    ((z = L.onVnodeUpdated) || V) && Ae(() => {
      z && He(z, g, d, f), V && dt(d, f, g, "updated");
    }, S);
  }, A = (f, d, g, S, w, v, O) => {
    for (let E = 0; E < d.length; E++) {
      const k = f[E], y = d[E], V = (
        ...
        !Ft(k, y) || // - In the case of a component, it could contain anything.
        k.shapeFlag & 198) ? p(k.el) : (
    ...
    if (d !== g) {
      ...
      for (const v in g) {
        if (Vt(v)) continue;
        const O = g[v], E = d[v];
        O !== E && v !== "value" && o(f, v, E, O, w, S);
      }
      "value" in g && o(f, "value", d.value, g.value, w);
    }
  }, he = (f, d, g, S, w, v, O, E, k) => {
    const y = d.el = f ? f.el : l(""), V = d.anchor = f ? f.anchor : l("");
    let { patchFlag: M, dynamicChildren: L, slotScopeIds: z } = d;
    z && (E = E ? E.concat(z) : z), f == null ? (n(y, g, S), n(V, g, S), Y(
      // #10007
      ...
      E,
      k
    )) : M > 0 && M & 64 && L && // #2715 the previous fragment could've been a BAILed one as a result
    // of renderSlot() with no valid children
    f.dynamicChildren && f.dynamicChildren.length === L.length ? (A(
      f.dynamicChildren,
      L,
      g,
      w,
    ...
    d.slotScopeIds = E, f == null ? d.shapeFlag & 512 ? w.ctx.activate(
      d,
      g,
      S,
      O,
    ...
    const E = f.component = Rl(
      f,
      S,
      w
    );
    if (so(f) && (E.ctx.renderer = $t), $l(E, !1, O), E.asyncDep) {
      if (w && w.registerDep(E, x, O), !f.el) {
        const k = E.subTree = Ce(ft);
        G(null, k, d, g), f.placeholder = k.el;
      }
    } else
      x(
        E,
    ...
    const E = () => {
      if (f.isMounted) {
        let { next: M, bu: L, u: z, parent: Q, vnode: oe } = f;
        {
          const Ne = xo(f);
          if (Ne) {
            M && (M.el = oe.el, D(f, M, O)), Ne.asyncDep.then(() => {
              Ae(() => {
                f.isUnmounted || y();
              }, w);
            });
        ...
        let te = M, ke;
        pt(f, !1), M ? (M.el = oe.el, D(f, M, O)) : M = oe, L && ds(L), (ke = M.props && M.props.onVnodeBeforeUpdate) && He(ke, Q, M, oe), pt(f, !0);
        const Te = Qn(f), Le = f.subTree;
        f.subTree = Te, m(
          Le,
          Te,
          ...
          w,
          v
        ), M.el = Te.el, te === null && ml(f, Te.el), z && Ae(z, w), (ke = M.props && M.props.onVnodeUpdated) && Ae(
          () => He(ke, Q, M, oe),
          w
        );
      } else {
        let M;
        const { el: L, props: z } = d, { bm: Q, m: oe, parent: te, root: ke, type: Te } = f, Le = Kt(d);
        pt(f, !1), Q && ds(Q), !Le && (M = z && z.onVnodeBeforeMount) && He(M, te, d), pt(f, !0);
        {
          ke.ce && ke.ce._hasShadowRoot() && ke.ce._injectChildStyle(
            Te,
            f.parent ? f.parent.type : void 0
          );
          const Ne = f.subTree = Qn(f);
          m(
            null,
            Ne,
            g,
        ...
        if (oe && Ae(oe, w), !Le && (M = z && z.onVnodeMounted)) {
          const Ne = d;
          Ae(
            () => He(M, te, Ne),
            w
        ...
        (d.shapeFlag & 256 || te && Kt(te.vnode) && te.vnode.shapeFlag & 256) && f.a && Ae(f.a, w), f.isMounted = !0, d = g = S = null;
      }
    };
    f.scope.on();
    const k = f.effect = new Ri(E);
    f.scope.off();
    const y = f.update = k.run.bind(k), V = f.job = k.runIfDirty.bind(k);
    V.i = f, V.id = f.uid, k.scheduler = () => An(V), pt(f, !0), y();
  }, D = (f, d, g) => {
    d.component = f;
    const S = f.vnode.props;
    f.vnode = d, f.next = null, bl(f, d.props, S, g), yl(f, d.children, g), nt(), Kn(f), it();
  }, F = (f, d, g, S, w, v, O, E, k = !1) => {
    const y = f && f.children, V = f ? f.shapeFlag : 0, M = d.children, { patchFlag: L, shapeFlag: z } = d;
    if (L > 0) {
      if (L & 128) {
        rs(
          y,
    ...
    z & 8 ? (V & 16 && Rt(y, w, v), M !== y && a(g, M)) : V & 16 ? z & 16 ? rs(
      y,
      M,
      g,
      S,
  ...
  }, Ge = (f, d, g, S, w, v, O, E, k) => {
    f = f || St, d = d || St;
    const y = f.length, V = d.length, M = Math.min(y, V);
    let L;
    for (L = 0; L < M; L++) {
      const z = d[L] = k ? Ze(d[L]) : Ke(d[L]);
      m(
        f[L],
        z,
        g,
  ...
  }, rs = (f, d, g, S, w, v, O, E, k) => {
    let y = 0;
    const V = d.length;
    let M = f.length - 1, L = V - 1;
    for (; y <= M && y <= L; ) {
      const z = f[y], Q = d[y] = k ? Ze(d[y]) : Ke(d[y]);
      if (Ft(z, Q))
        m(
          z,
          Q,
    ...
    for (; y <= M && y <= L; ) {
      const z = f[M], Q = d[L] = k ? Ze(d[L]) : Ke(d[L]);
      if (Ft(z, Q))
        m(
          z,
          Q,
    ...
    if (y > M) {
      ...
      const z = y, Q = y, oe = /* @__PURE__ */ new Map();
      for (y = Q; y <= L; y++) {
        const Ee = d[y] = k ? Ze(d[y]) : Ke(d[y]);
        Ee.key != null && oe.set(Ee.key, y);
      }
      let te, ke = 0;
      const Te = L - Q + 1;
      let Le = !1, Ne = 0;
      const Dt = new Array(Te);
      for (y = 0; y < Te; y++) Dt[y] = 0;
      for (y = z; y <= M; y++) {
        const Ee = f[y];
        if (ke >= Te) {
          Fe(Ee, w, v, !0);
        ...
        if (Ee.key != null)
          ...
          for (te = Q; te <= L; te++)
            if (Dt[te - Q] === 0 && Ft(Ee, d[te])) {
              Ve = te;
              break;
            }
        Ve === void 0 ? Fe(Ee, w, v, !0) : (Dt[Ve - Q] = y + 1, Ve >= Ne ? Ne = Ve : Le = !0, m(
          Ee,
          d[Ve],
          g,
          null,
      ...
      const jn = Le ? kl(Dt) : St;
      for (te = jn.length - 1, y = Te - 1; y >= 0; y--) {
        const Ee = Q + y, Ve = d[Ee], Fn = d[Ee + 1], Ln = Ee + 1 < V ? (
        ...
        Dt[y] === 0 ? m(
          ...
          E,
          k
        ) : Le && (te < 0 || y !== jn[te] ? ut(Ve, g, Ln, 2) : te--);
      }
    }
  }, ut = (f, d, g, S, w = null) => {
    const { el: v, type: O, transition: E, children: k, shapeFlag: y } = f;
    if (y & 6) {
      ut(f.component.subTree, d, g, S);
      return;
    }
    if (y & 128) {
    ...
    if (S !== 2 && y & 1 && E)
      if (S === 0)
        E.beforeEnter(v), n(v, d, g), Ae(() => E.enter(v), w);
      else {
        const { leave: M, delayLeave: L, afterLeave: z } = E, Q = () => {
          f.ctx.isUnmounted ? i(v) : n(v, d, g);
        }, oe = () => {
          v._isLeaving && v[Nr](
            !0
            /* cancelled */
    ...
    if (M === -2 && (w = !1), E != null && (nt(), Ut(E, null, g, f, !0), it()), z != null && (d.renderCache[z] = void 0), V & 256) {
      d.ctx.deactivate(f);
      return;
    }
    const Q = V & 1 && L, oe = !Kt(f);
    let te;
    if (oe && (te = O && O.onVnodeBeforeUnmount) && He(te, d, f), V & 6)
      Lo(f.component, g, S);
    else {
      if (V & 128) {
      ...
      Q && dt(f, null, d, "beforeUnmount"), V & 64 ? f.type.remove(
        f,
        d,
        g,
        $t,
      ...
      (v !== le || M > 0 && M & 64) ? Rt(
        ...
        !1,
        !0
      ) : (v === le && M & 384 || !w && V & 16) && Rt(k, d, g), S && $n(f);
    }
    (oe && (te = O && O.onVnodeUnmounted) || Q) && Ae(() => {
      te && He(te, d, f), Q && dt(f, null, d, "unmounted");
    }, g);
  }, $n = (f) => {
    const { type: d, el: g, anchor: S, transition: w } = f;
    if (d === le) {
      Fo(g, S);
      return;
    }
    ...
    if (f.shapeFlag & 1 && w && !w.persisted) {
      const { leave: O, delayLeave: E } = w, k = () => O(g, v);
      E ? E(f.el, v, k) : k();
    } else
      v();
  }, Fo = (f, d) => {
    ...
    const { bum: S, scope: w, job: v, subTree: O, um: E, m: k, a: y } = f;
    ti(k), ti(y), S && ds(S), w.stop(), v && (v.flags |= 8, Fe(O, f, d, g)), E && Ae(E, d), Ae(() => {
      f.isUnmounted = !0;
    }, d);
  }, Rt = (f, d, g, S = !1, w = !1, v = 0) => {
    for (let O = v; O < f.length; O++)
      Fe(f[O], d, g, S, w);
  }, ls = (f) => {
    if (f.shapeFlag & 6)
    ...
    const d = _(f.anchor || f.el), g = d && d[Fr];
    return g ? _(g) : d;
  };
  let Ws = !1;
  const Dn = (f, d, g) => {
    let S;
    f == null ? d._vnode && (Fe(d._vnode, null, null, !0), S = d._vnode.component) : m(
      d._vnode || null,
      f,
      d,
      null,
      ...
      null,
      g
    ), d._vnode = f, Ws || (Ws = !0, Kn(S), Gi(), Ws = !1);
  }, $t = {
    p: m,
    um: Fe,
    m: ut,
...
function wo(e, t, s = !1) {
  ...
  if (H(n) && H(i))
    for (let o = 0; o < n.length; o++) {
      const r = n[o];
      let l = i[o];
      l.shapeFlag & 1 && !l.dynamicChildren && ((l.patchFlag <= 0 || l.patchFlag === 32) && (l = i[o] = Ze(i[o]), l.el = r.el), !s && l.patchFlag !== -2 && wo(r, l)), l.type === zs && (l.patchFlag === -1 && (l = i[o] = Ze(l)), l.el = r.el), l.type === ft && !l.el && (l.el = r.el);
    }
}
function kl(e) {
  const t = e.slice(), s = [0];
...
const le = /* @__PURE__ */ Symbol.for("v-fgt"), zs = /* @__PURE__ */ Symbol.for("v-txt"), ft = /* @__PURE__ */ Symbol.for("v-cmt"), Zs = /* @__PURE__ */ Symbol.for("v-stc"), Bt = [];
let Ie = null;
function j(e = !1) {
  Bt.push(Ie = e ? null : []);
}
...
let Zt = 1;
function si(e, t = !1) {
  Zt += e, e < 0 && Ie && t && (Ie.hasOnce = !0);
}
function _o(e) {
  return e.dynamicChildren = Zt > 0 ? Ie || St : null, Al(), Zt > 0 && Ie && Ie.push(e), e;
}
...
const ko = ({ key: e }) => e ?? null, ps = ({
  ref: e,
  ref_key: t,
  ref_for: s
}) => (typeof e == "number" && (e = "" + e), e != null ? de(e) || /* @__PURE__ */ ae(e) || W(e) ? { i: Oe, r: e, k: t, f: !!s } : e : null);
function h(e, t = null, s = null, n = 0, i = null, o = e === le ? 0 : 1, r = !1, l = !1) {
  const c = {
    __v_isVNode: !0,
    __v_skip: !0,
    type: e,
  ...
  return l ? (Mn(c, s), o & 128 && e.normalize(c)) : s && (c.shapeFlag |= de(s) ? 8 : 16), Zt > 0 && // avoid a block node from tracking itself
...
const Ce = El;
function El(e, t = null, s = null, n = 0, i = null, o = !1) {
  if ((!e || e === Zr) && (e = ft), Co(e)) {
    const l = Ot(
      e,
      t,
    ...
    return s && Mn(l, s), Zt > 0 && !o && Ie && (l.shapeFlag & 6 ? Ie[Ie.indexOf(e)] = l : Ie.push(l)), l.patchFlag = -2, l;
  }
  if (Nl(e) && (e = e.__vccOpts), t) {
    t = Pl(t);
    let { class: l, style: c } = t;
    l && !de(l) && (t.class = se(l)), ne(c) && (/* @__PURE__ */ Fs(c) && !H(c) && (c = ue({}, c)), t.style = Jt(c));
  }
  const r = de(e) ? 1 : yo(e) ? 128 : Lr(e) ? 64 : ne(e) ? 4 : W(e) ? 2 : 0;
  return h(
    e,
    t,
    s,
...
function Pl(e) {
  return e ? /* @__PURE__ */ Fs(e) || uo(e) ? ue({}, e) : e : null;
}
function Ot(e, t, s = !1, n = !1) {
  const { props: i, ref: o, patchFlag: r, children: l, transition: c } = e, u = t ? Ol(i || {}, t) : i, a = {
    __v_isVNode: !0,
    __v_skip: !0,
    type: e.type,
    props: u,
    ...
    ref: t && t.ref ? (
      ...
      s && o ? H(o) ? o.concat(ps(t)) : [o, ps(t)] : ps(t)
    ) : o,
    scopeId: e.scopeId,
...
function pe(e = "", t = !1) {
  return t ? (j(), So(ft, null, e)) : Ce(ft, null, e);
}
function Ke(e) {
  return e == null || typeof e == "boolean" ? Ce(ft) : H(e) ? Ce(
    le,
    null,
    // #3666, avoid reference pollution when reusing vnode
    e.slice()
  ) : Co(e) ? Ze(e) : Ce(zs, null, String(e));
}
function Ze(e) {
...
function Mn(e, t) {
  ...
  if (t == null)
    ...
    if (n & 65) {
      ...
      s = 32;
      const i = t._;
      !i && !uo(t) ? t._ctx = Oe : i === 3 && Oe && (Oe.slots._ === 1 ? t._ = 1 : (t._ = 2, e.patchFlag |= 1024));
    }
  else W(t) ? (t = { default: t, _ctx: Oe }, s = 32) : (t = String(t), n & 64 ? (s = 16, t = [It(t)]) : s = 8);
  ...
  for (let s = 0; s < e.length; s++) {
    ...
    for (const i in n)
      if (i === "class")
        ...
        const o = t[i], r = n[i];
        r && o !== r && !(H(o) && o.includes(r)) && (t[i] = o ? [].concat(o, r) : r);
      } else i !== "" && (t[i] = n[i]);
  }
  return t;
}
...
function $l(e, t = !1, s = !1) {
  t && pn(t);
  const { props: n, children: i } = e.vnode, o = Ao(e);
  gl(e, n, o, t), vl(e, i, s || t);
...
function Dl(e, t) {
  ...
  if (n) {
    nt();
    const i = e.setupContext = n.length > 1 ? Fl(e) : null, o = os(e), r = is(
      n,
      e,
      0,
      [
...
function ii(e, t, s) {
  W(t) ? e.type.__ssrInlineRender ? e.ssrRender = t : e.render = t : ne(t) && (e.setupState = qi(t)), Eo(e);
}
function Eo(e, t, s) {
  const n = e.type;
...
function Us(e) {
  return e.exposed ? e.exposeProxy || (e.exposeProxy = new Proxy(qi(Tn(e.exposed)), {
    get(t, s) {
      if (s in t)
        return t[s];
      if (s in Wt)
...
const be = (e, t) => /* @__PURE__ */ kr(e, t, es), Vl = "3.5.30";
/**
...
const Po = hn ? (e) => hn.createHTML(e) : (e) => e, Hl = "http://www.w3.org/2000/svg", zl = "http://www.w3.org/1998/Math/MathML", Qe = typeof document < "u" ? document : null, ri = Qe && /* @__PURE__ */ Qe.createElement("template"), Ul = {
  insert: (e, t, s) => {
  ...
  createElement: (e, t, s, n) => {
    const i = t === "svg" ? Qe.createElementNS(Hl, e) : t === "mathml" ? Qe.createElementNS(zl, e) : s ? Qe.createElement(e, { is: s }) : Qe.createElement(e);
...
const _s = /* @__PURE__ */ Symbol("_vod"), Oo = /* @__PURE__ */ Symbol("_vsh"), en = {
  // used for prop mismatch check during hydration
  name: "show",
  beforeMount(e, { value: t }, { transition: s }) {
    e[_s] = e.style.display === "none" ? "" : e.style.display, s && t ? s.beforeEnter(e) : Lt(e, t);
  },
...
function Lt(e, t) {
  e.style.display = t ? e[_s] : "none", e[Oo] = !t;
}
const Bl = /* @__PURE__ */ Symbol(""), ql = /(?:^|;)\s*display\s*:/;
function Yl(e, t, s) {
  ...
  if (s && !i) {
    ...
    if (t !== s) {
      const r = n[Bl];
      r && (s += ";" + r), n.cssText = s, o = ql.test(s);
    }
  } else t && e.removeAttribute("style");
  _s in e && (e[_s] = o ? n.display : "", e[Oo] && (n.display = "none"));
}
...
function ai(e, t, s, n, i, o = Yo(t)) {
  n && t.startsWith("xlink:") ? s == null ? e.removeAttributeNS(fi, t.slice(6, t.length)) : e.setAttributeNS(fi, t, s) : s == null || o && !Ai(s) ? e.removeAttribute(t) : e.setAttribute(
    t,
    o ? "" : qe(s) ? String(s) : s
  );
}
function ui(e, t, s, n, i) {
  ...
  if (s === "" || s == null) {
    const l = typeof e[t];
    l === "boolean" ? s = Ai(s) : s == null && l === "string" ? (s = "", r = !0) : l === "number" && (s = 0, r = !0);
  }
  try {
    e[t] = s;
  } catch {
...
let sn = 0;
const Zl = /* @__PURE__ */ Promise.resolve(), ec = () => sn || (Zl.then(() => sn = 0), sn = Date.now());
function tc(e, t) {
  const s = (n) => {
    if (!n._vts)
      n._vts = Date.now();
...
e.charCodeAt(2) > 96 && e.charCodeAt(2) < 123, nc = (e, t, s, n, i, o) => {
  const r = i === "svg";
  t === "class" ? Wl(e, n, r) : t === "style" ? Yl(e, s, n) : As(t) ? wn(t) || Xl(e, t, s, n, o) : (t[0] === "." ? (t = t.slice(1), !0) : t[0] === "^" ? (t = t.slice(1), !1) : ic(e, t, n, r)) ? (ui(e, t, n), !e.tagName.includes("-") && (t === "value" || t === "checked" || t === "selected") && ai(e, t, n, r, o, t !== "value")) : /* #11081 force set props for possible async custom element */ e._isVueCE && // #12408 check if it's declared prop or it's async custom element
  (oc(e, t) || // @ts-expect-error _def is private
  e._def.__asyncLoader && (/[A-Z]/.test(t) || !de(n))) ? ui(e, me(t), n, o, t) : (t === "true-value" ? e._trueValue = n : t === "false-value" && (e._falseValue = n), ai(e, t, n, r));
};
function ic(e, t, s, n) {
  if (n)
    return !!(t === "innerHTML" || t === "textContent" || t in e && hi(t) && W(s));
...
class Rn extends rc {
  constructor(t, s = {}, n = vi) {
    super(), this._def = t, this._props = s, this._createApp = n, this._isVueCE = !0, this._instance = null, this._app = null, this._nonce = this._def.nonce, this._connected = !1, this._resolved = !1, this._patching = !1, this._dirty = !1, this._numberProps = null, this._styleChildren = /* @__PURE__ */ new WeakSet(), this._styleAnchors = /* @__PURE__ */ new WeakMap(), this._ob = null, this.shadowRoot && n !== vi ? this._root = this.shadowRoot : t.shadowRoot !== !1 ? (this.attachShadow(
  ...
  _resolveDef() {
    ...
    const t = (n, i = !1) => {
      ...
      if (o && !H(o))
        for (const c in o) {
          const u = o[c];
          (u === Number || u && u.type === Number) && (c in this._props && (this._props[c] = Vn(this._props[c])), (l || (l = /* @__PURE__ */ Object.create(null)))[me(c)] = !0);
        }
  ...
  _mount(t) {
    ...
    if (s)
      for (const n in s)
        ee(this, n) || Object.defineProperty(this, n, {
  ...
  _setAttr(t) {
    ...
    let n = s ? this.getAttribute(t) : mi;
    const i = me(t);
  ...
  _setProp(t, s, n = !0, i = !1) {
    if (s !== this._props[t] && (this._dirty = !0, s === mi ? delete this._props[t] : (this._props[t] = s, t === "key" && this._app && (this._app._ceVNode.key = s)), i && this._instance && this._update(), n)) {
      const o = this._ob;
  ...
  _update() {
    ...
    this._app && (t.appContext = this._app._context), dc(t, this._root);
  }
  _createVNode() {
    const t = {};
    this.shadowRoot || (t.onVnodeMounted = t.onVnodeUpdated = this._renderSlots.bind(this));
    const s = Ce(this._def, ue(t, this._props));
    return this._instance || (s.ce = (n) => {
      ...
      const i = (o, r) => {
        this.dispatchEvent(
          new CustomEvent(
            o,
            Ps(r[0]) ? ue({ detail: r }, r[0]) : { detail: r }
          )
        );
      };
      n.emit = (o, ...r) => {
  ...
  _applyStyles(t, s, n) {
    ...
    const i = this._nonce, o = this.shadowRoot, r = n ? this._getStyleAnchor(n) || this._getStyleAnchor(this._def) : this._getRootStyleInsertionAnchor(o);
    let l = null;
    for (let c = t.length - 1; c >= 0; c--) {
      const u = document.createElement("style");
      i && u.setAttribute("nonce", i), u.textContent = t[c], o.insertBefore(u, l || r), l = u, c === 0 && (n || this._styleAnchors.set(this._def, u), s && this._styleAnchors.set(s, u));
    }
  }
  _getStyleAnchor(t) {
    if (!t)
...
const Cs = {
  created(e, { modifiers: { lazy: t, trim: s, number: n } }, i) {
    ...
    mt(e, t ? "change" : "input", (r) => {
      r.target.composing || e[At](bi(e.value, s, o));
    }), (s || o) && mt(e, "change", () => {
      e.value = bi(e.value, s, o);
    }), t || (mt(e, "compositionstart", lc), mt(e, "compositionend", gi), mt(e, "change", gi));
  },
  ...
  beforeUpdate(e, { value: t, oldValue: s, modifiers: { lazy: n, trim: i, number: o } }, r) {
    if (e[At] = Ss(r), e.composing) return;
    const l = (o || e.type === "number") && !/^0\d/.test(e.value) ? Rs(e.value) : e.value, c = t ?? "";
...
function wi(e, t) {
  const s = e.multiple, n = H(t);
  if (!(s && !n && !Es(t))) {
    for (let i = 0, o = e.options.length; i < o; i++) {
      const r = e.options[i], l = ks(r);
      if (s)
        if (n) {
          const c = typeof l;
          c === "string" || c === "number" ? r.selected = t.some((u) => String(u) === String(l)) : r.selected = Go(t, l) > -1;
        } else
          r.selected = t.has(l);
      else if (ns(ks(r), t)) {
...
const cc = ["ctrl", "shift", "alt", "meta"], fc = {
...
}, uc = /* @__PURE__ */ ue({ patchProp: nc }, Ul);
let xi;
function Io() {
  return xi || (xi = _l(uc));
}
...
function ia() {
  const e = Ii(!0), t = e.run(() => /* @__PURE__ */ U({}));
  let s = [], n = [];
  const i = Tn({
    install(o) {
      Ks(i), i._a = o, o.provide(Ro, i), o.config.globalProperties.$pinia = i, n.forEach((r) => s.push(r)), n = [];
    },
    use(o) {
...
const mc = (e) => e(), _i = Symbol(), nn = Symbol();
function gn(e, t) {
  ...
  for (const s in t) {
    if (!t.hasOwnProperty(s))
      continue;
    const n = t[s], i = e[s];
    mn(i) && mn(n) && e.hasOwnProperty(s) && !/* @__PURE__ */ ae(n) && !/* @__PURE__ */ st(n) ? e[s] = gn(i, n) : e[s] = n;
  }
  return e;
}
const gc = (
...
function bc(e) {
  return !mn(e) || !e.hasOwnProperty(gc);
}
...
function xc(e, t, s, n) {
  ...
  function u() {
    ...
    const a = /* @__PURE__ */ yr(s.state.value[e]);
    return lt(a, o, Object.keys(r || {}).reduce((p, _) => (p[_] = Tn(be(() => {
      Ks(s);
      const C = s._s.get(e);
      return r[_].call(C, C);
    })), p), {}));
  }
  return c = Do(e, u, t, s, n, !0), c;
}
function Do(e, t, s = {}, n, i, o) {
  ...
  function T(Y) {
    let I;
    u = a = !1, typeof Y == "function" ? (Y(n.state.value[e]), I = {
      type: qt.patchFunction,
      storeId: e,
      events: C
    }) : (gn(n.state.value[e], Y), I = {
      type: qt.patchObject,
      payload: Y,
      storeId: e,
      events: C
    ...
    Mt().then(() => {
      m === A && (u = !0);
    }), a = !0, yt(p, I, n.state.value[e]);
  }
  const G = o ? function() {
    const { state: I } = s, A = I ? I() : {};
    this.$patch((ce) => {
      lt(ce, A);
    });
  } : (
  ...
  const X = (Y, I = "") => {
    ...
    const A = function() {
      Ks(n);
      const ce = Array.from(arguments), he = [], R = [];
      function ye(D) {
        he.push(D);
      }
      function q(D) {
      ...
      let x;
      try {
        x = Y.apply(this && this.$id === e ? this : J, ce);
      } catch (D) {
        throw yt(R, D), D;
      }
      return x instanceof Promise ? x.then((D) => (yt(he, D), D)).catch((D) => (yt(R, D), Promise.reject(D))) : (yt(he, x), x);
    };
    return A[_i] = !0, A[nn] = I, A;
  }, $ = {
    _p: n,
    // _s: scope,
    $id: e,
    $onAction: yi.bind(null, _),
    $patch: T,
    $reset: G,
    $subscribe(Y, I = {}) {
      const A = yi(p, Y, I.detached, () => ce()), ce = r.run(() => Tt(() => n.state.value[e], (he) => {
        (I.flush === "sync" ? a : u) && Y({
          storeId: e,
          type: qt.direct,
          events: C
  ...
  n._s.set(e, J);
  const fe = (n._a && n._a.runWithContext || mc)(() => n._e.run(() => (r = Ii()).run(() => t({ action: X }))));
  for (const Y in fe) {
    const I = fe[Y];
    if (/* @__PURE__ */ ae(I) && !wc(I) || /* @__PURE__ */ st(I))
      o || (P && bc(I) && (/* @__PURE__ */ ae(I) ? I.value = P[Y] : gn(I, P[Y])), n.state.value[e][Y] = I);
    else if (typeof I == "function") {
      const A = X(I, Y);
      fe[Y] = A, l.actions[Y] = I;
    }
  }
  return lt(J, fe), lt(/* @__PURE__ */ Z(J), fe), Object.defineProperty(J, "$state", {
    get: () => n.state.value[e],
    set: (Y) => {
      T((I) => {
        lt(I, Y);
  ...
  }), P && o && s.hydrate && s.hydrate(J.$state, P), u = !0, a = !0, J;
}
/*! #__NO_SIDE_EFFECTS__ */
// @__NO_SIDE_EFFECTS__
function vc(e, t, s) {
  ...
  function r(l, c) {
    ...
    l || (u ? bt(Ro, null) : null), l && Ks(l), l = Mo, l._s.has(n) || (o ? Do(n, t, i, l) : xc(n, i, l)), l._s.get(n);
  }
  return r.$id = n, r;
}
const Je = /* @__PURE__ */ vc("widget", () => {
  const e = /* @__PURE__ */ U({
    endpoint: "",
    issuesEndpoint: "",
    actionEndpoint: "",
    ...
    labels: "",
    storageKey: "thoughts"
  }), t = /* @__PURE__ */ U("text"), s = /* @__PURE__ */ U("right"), n = /* @__PURE__ */ U("bottom"), i = /* @__PURE__ */ U(""), o = /* @__PURE__ */ U(""), r = /* @__PURE__ */ U(""), l = /* @__PURE__ */ U("manual"), c = /* @__PURE__ */ U("technical_issue"), u = /* @__PURE__ */ U({}), a = /* @__PURE__ */ U({
    shortLeft: "done_archive",
    shortRight: "pin_unpin",
    longLeft: "create_linked_item",
    longRight: "comment"
  }), p = /* @__PURE__ */ U([]), _ = /* @__PURE__ */ U(!1), C = /* @__PURE__ */ U(!1), P = /* @__PURE__ */ U("active"), m = /* @__PURE__ */ U("updated_desc"), T = /* @__PURE__ */ U(""), G = /* @__PURE__ */ U([]), B = /* @__PURE__ */ U(!1), X = /* @__PURE__ */ U(""), $ = /* @__PURE__ */ U(""), J = /* @__PURE__ */ U(!1), ve = /* @__PURE__ */ U(null), fe = /* @__PURE__ */ U(""), Y = /* @__PURE__ */ U("");
  function I(A) {
    e.value = A, t.value = "text";
  }
  return {
    config: e,
    mobileTab: t,
...
function Yt() {
  const e = bt("widget-adapter");
  if (!e) throw new Error("WidgetAdapter not provided");
  return {
    readToken: e.readToken,
    requireToken: e.requireToken,
    promptToken: e.promptToken,
    writeToken: e.clearToken
    // Alias clear to write for backwards compat if needed, though mostly unused outside core now
  };
}
function jo() {
  const e = Je(), { persist: t } = at();
  let s = 0;
  function n(o) {
...
const yc = 10;
function _c() {
  const e = Je(), { persist: t } = at(), { submitText: s, cancelSubmission: n, loadIssues: i } = Et(), o = /* @__PURE__ */ U(0);
  let r = null;
  function l() {
    r !== null && (clearInterval(r), r = null), o.value = 0;
  }
  function c() {
    l(), e.lastSubmissionId && (o.value = yc, r = setInterval(() => {
      o.value -= 1, o.value <= 0 && l();
    }, 1e3));
  }
  async function u(_) {
    if (e.creating) return;
    const C = e.draftDescription.trim();
    if (!C) {
      e.createError = "Please provide a description.";
      return;
    }
    let P = e.draftTitle.trim();
    if (!P) {
      const m = C.split(`
`)[0];
      P = m.length > 50 ? m.slice(0, 50) + "..." : m;
    }
    e.createError = "", e.creating = !0;
    try {
      const m = await s(P, C, _);
      e.lastSubmissionId = typeof (m == null ? void 0 : m.submissionId) == "string" ? m.submissionId : null, e.lastTextTitle = P, e.lastTextDescription = e.draftDescription, e.draftTitle = "", e.draftDescription = "", e.textCreateSuccess = !0, c(), i(!0), t();
    } catch (m) {
      e.createError = m instanceof Error ? m.message : "Failed to create request";
    } finally {
      e.creating = !1;
    }
  }
  async function a() {
    ...
    const _ = e.lastSubmissionId;
    await n(_), e.lastSubmissionId = null, e.textCreateSuccess = !1, e.draftTitle = e.lastTextTitle, e.draftDescription = e.lastTextDescription, l(), t();
  }
  function p() {
...
const Cc = 40;
function kc() {
  const e = Je(), { persist: t } = at(), s = /* @__PURE__ */ U(!1), n = /* @__PURE__ */ U(!1);
  let i = 0;
  const o = be(() => e.handedness === "left" ? { left: "10px", right: "" } : { right: "10px", left: "" });
  function r(p) {
    i = p.touches[0].clientX;
  }
  function l(p) {
    const _ = p.changedTouches[0].clientX - i;
    Math.abs(_) >= Cc && (e.handedness = _ < 0 ? "left" : "right", t(), p.preventDefault());
  }
  function c() {
    s.value = !0;
  }
...
const Tc = { class: "cfw-text-form-wrap" }, Ac = { class: "cfw-textarea-wrap" }, Ec = ["id", "placeholder"], Pc = {
  key: 1,
  class: "cfw-mf-actions"
}, Oc = ["disabled"], Ic = {
  key: 2,
  id: "cfw-new-actions"
}, Mc = ["disabled"], Rc = /* @__PURE__ */ xt({
  __name: "TextForm",
  props: {
    mobile: { type: Boolean },
    titleId: { type: String },
  ...
  setup(e, { expose: t, emit: s }) {
    const n = e, i = Je(), { persist: o } = at(), r = be(() => n.descId ?? (n.mobile ? "cfw-m-description" : "cfw-description")), l = be(() => {
      switch (i.mode) {
        case "personal_todo":
    ...
    function _() {
      const P = p.value;
      P && (P.style.height = "auto", P.style.height = P.scrollHeight + "px", P.style.overflowY = P.offsetHeight < P.scrollHeight ? "auto" : "hidden");
    }
    function C() {
      _(), u();
    }
    return Vs(() => _()), t({ focusTitle: () => {
      var P;
      ...
      h("div", Ac, [
        $e(h("textarea", {
          ...
          ref: p,
          id: r.value,
          "onUpdate:modelValue": m[0] || (m[0] = (T) => b(i).draftDescription = T),
          placeholder: l.value,
          maxlength: "5000",
          onInput: C,
          onKeydown: [
            m[1] || (m[1] = Ts(ts((T) => c.value && !b(i).creating && P.$emit("create", !0), ["ctrl"]), ["enter"])),
            m[2] || (m[2] = Ts(ts((T) => c.value && !b(i).creating && P.$emit("create", !0), ["meta"]), ["enter"]))
          ]
        }, null, 40, Ec), [
          [Cs, b(i).draftDescription]
        ])
      ]),
      b(i).createError ? (j(), N("div", {
        key: 0,
        class: se([["cfw-error", e.mobile ? "cfw-mf-error" : ""], "active"])
      }, K(b(i).createError), 3)) : pe("", !0),
      e.mobile ? (j(), N("div", Pc, [
        c.value ? (j(), N("button", {
          key: 0,
          id: "cfw-m-clear",
        ...
        h("button", {
          ...
          type: "button",
          disabled: b(i).creating,
          onClick: m[3] || (m[3] = (T) => P.$emit("create", !1))
        }, K(b(i).creating ? "Saving..." : "Submit"), 9, Oc)
      ])) : (j(), N("div", Ic, [
        h("button", {
          id: "cfw-submit",
          type: "button",
          class: "cfw-btn cfw-btn-primary",
          disabled: b(i).creating,
          onClick: m[4] || (m[4] = (T) => P.$emit("create", !1))
        }, K(b(i).creating ? "Saving..." : "Submit"), 9, Mc)
      ]))
    ]));
  }
}), $c = [
  ...
  key: 0,
  id: "cfw-mbs-content"
}, Lc = { class: "cfw-is-status" }, Nc = { class: "cfw-is-num" }, Vc = {
  class: "cfw-is-action-row",
  style: { "margin-top": "8px" }
}, Hc = ["disabled"], zc = ["href"], Uc = {
  key: 0,
  class: "cfw-is-body",
  ...
  key: 1,
  class: "cfw-is-badges"
}, Wc = { class: "cfw-is-primary-box" }, Bc = {
  key: 1,
  class: "cfw-is-action-row"
}, qc = {
  key: 2,
...
}, Jc = { class: "cfw-comment-meta" }, Gc = { class: "cfw-comment-body" }, Xc = { class: "cfw-comment-meta" }, Qc = { class: "cfw-comment-body" }, Zc = {
  key: 3,
  class: "cfw-is-section"
}, ef = ["href"], tf = {
  key: 4,
  class: "cfw-is-section"
}, sf = { class: "cfw-is-actions" }, nf = ["disabled", "onClick"], of = {
  key: 0,
  ...
  key: 1,
  id: "cfw-mbs-content"
}, pf = { class: "cfw-fs-section" }, hf = { class: "cfw-fs-pills" }, mf = ["onClick"], gf = { class: "cfw-fs-section" }, bf = { class: "cfw-fs-pills" }, wf = ["onClick"], xf = { class: "cfw-fs-section" }, vf = { class: "cfw-fs-chips" }, yf = ["onClick"], _f = /* @__PURE__ */ xt({
  __name: "IssueSheet",
  props: {
    open: { type: Boolean },
  ...
  setup(e, { emit: t }) {
    const s = e, n = t, i = Je(), { persist: o } = at(), { executeAction: r, mapActionError: l } = Et(), c = /* @__PURE__ */ U(!1), u = /* @__PURE__ */ U(""), a = /* @__PURE__ */ U(!1), p = /* @__PURE__ */ U(""), _ = /* @__PURE__ */ U("");
    Tt(() => s.editMode, (I) => {
      I && s.issue && (p.value = s.issue.title, _.value = s.issue.body || "");
    });
    const C = be(() => s.issue ? s.issue.comments && s.issue.comments.length > 0 || s.issue.status !== "new" : !1), P = be(() => {
      var I;
      return (I = s.issue) != null && I.comments ? [...s.issue.comments].sort((A, ce) => new Date(ce.createdAt).getTime() - new Date(A.createdAt).getTime()) : [];
    }), m = be(() => P.value.length > 0), T = be(() => P.value[0] || null), G = be(() => P.value.slice(1));
    function B(I) {
      return new Date(I).toLocaleDateString(void 0, { month: "short", day: "numeric", hour: "numeric", minute: "2-digit" });
    }
    const X = be(() => {
      var I;
      return Array.isArray((I = s.issue) == null ? void 0 : I.issueActions) ? s.issue.issueActions : [];
    }), $ = be(() => {
      var I;
      return Array.isArray((I = s.issue) == null ? void 0 : I.pullRequestActions) ? s.issue.pullRequestActions : [];
    });
    async function J(I, A, ce) {
      u.value = "", c.value = !0;
      try {
        await r(I, ce, A), n("action-done"), n("close");
      } catch (he) {
        u.value = l(he instanceof Error ? he.message : "");
      } finally {
        c.value = !1;
      }
    }
    async function ve() {
      ...
      if (I) {
        ...
        try {
          ...
          u.value = l(A instanceof Error ? A.message : "");
        } finally {
          c.value = !1;
        }
      }
    ...
    function fe(I) {
      const A = i.listStatusFilter.slice(), ce = A.indexOf(I);
      ce >= 0 ? A.splice(ce, 1) : A.push(I), i.listStatusFilter = A, o(), n("filter-changed");
    }
    function Y() {
    ...
    return (I, A) => {
      ...
      return j(), N(le, null, [
        h("div", {
          id: "cfw-mbs-overlay",
          class: se({ active: e.open }),
          onClick: A[0] || (A[0] = (R) => I.$emit("close"))
        }, null, 2),
        h("div", {
          id: "cfw-mbs",
          class: se({ active: e.open, "panel-left": b(i).handedness === "left" })
        }, [
          A[16] || (A[16] = h("div", { id: "cfw-mbs-handle" }, null, -1)),
          e.issue ? (j(), N("div", Fc, [
            h("div", Lc, K(e.issue.status || e.issue.state) + K(e.issue.statusDetail ? " · " + e.issue.statusDetail : ""), 1),
            h("div", Nc, "#" + K(e.issue.number) + " · " + K(B(e.issue.updatedAt)), 1),
            e.editMode ? (j(), N(le, { key: 0 }, [
              $e(h("input", {
              ...
              $e(h("textarea", {
                "onUpdate:modelValue": A[2] || (A[2] = (R) => _.value = R),
              ...
              h("div", Vc, [
                h("button", {
                  class: "cfw-btn cfw-btn-outline",
                  onClick: A[3] || (A[3] = (R) => I.$emit("cancel-edit")),
                  style: { flex: "1" }
                }, "Cancel"),
                h("button", {
                  class: "cfw-btn cfw-btn-primary",
              ...
              }, K(e.issue.title), 9, zc),
              e.issue.body ? (j(), N("div", Uc, K(e.issue.body), 1)) : pe("", !0),
              (ce = e.issue.labels) != null && ce.length ? (j(), N("div", Kc, [
                (j(!0), N(le, null, Re(e.issue.labels, (R) => (j(), N("span", {
                  key: R,
                  class: "cfw-badge"
                }, K(R), 1))), 128))
              ])) : pe("", !0),
              h("div", Wc, [
                C.value ? (j(), N("button", {
                  ...
                  onClick: A[4] || (A[4] = (R) => I.$emit("compose-sheet", "comment", e.issue))
                }, "Comment")) : (j(), N("div", Bc, [
                  h("button", {
                    class: "cfw-btn cfw-btn-outline",
                    onClick: A[5] || (A[5] = (R) => I.$emit("edit-issue", e.issue))
                  }, "Edit"),
                  h("button", {
                    class: "cfw-btn cfw-btn-primary",
                    onClick: A[6] || (A[6] = (R) => I.$emit("compose-sheet", "comment", e.issue))
                  }, "Comment")
                ]))
              ])
            ], 64)),
            m.value ? (j(), N("div", qc, [
              T.value ? (j(), N("div", Yc, [
                h("div", Jc, [
                  h("strong", null, K(T.value.author || "User"), 1),
                  It(" · " + K(B(T.value.createdAt)), 1)
                ]),
                h("div", Gc, K(T.value.body), 1)
              ])) : pe("", !0),
              G.value.length > 0 ? (j(), N(le, { key: 1 }, [
                a.value ? (j(!0), N(le, { key: 1 }, Re(G.value, (R) => (j(), N("div", {
                  key: R.id,
                  class: "cfw-comment"
                }, [
                  h("div", Xc, [
                    h("strong", null, K(R.author || "User"), 1),
                    It(" · " + K(B(R.createdAt)), 1)
                  ]),
                  h("div", Qc, K(R.body), 1)
                ]))), 128)) : (j(), N("button", {
                  key: 0,
                  class: "cfw-comments-expand",
                  onClick: A[7] || (A[7] = (R) => a.value = !0)
                }, " Show " + K(G.value.length) + " previous comment" + K(G.value.length > 1 ? "s" : ""), 1))
              ], 64)) : pe("", !0)
            ])) : pe("", !0),
            e.issue.sourceIssue ? (j(), N("div", Zc, [
              A[10] || (A[10] = h("div", { class: "cfw-is-section-label" }, "Source Item", -1)),
              h("a", {
                class: "cfw-is-pr-link",
                href: e.issue.sourceIssue.url,
                target: "_blank",
                rel: "noopener noreferrer"
              }, " #" + K(e.issue.sourceIssue.number) + " " + K(e.issue.sourceIssue.title), 9, ef)
            ])) : pe("", !0),
            X.value.length ? (j(), N("div", tf, [
              A[11] || (A[11] = h("div", { class: "cfw-is-section-label" }, "Issue actions", -1)),
              h("div", sf, [
                (j(!0), N(le, null, Re(X.value, (R) => (j(), N("div", {
                  key: R.id
                }, [
                  h("button", {
                    class: "cfw-is-action-btn",
                    disabled: R.disabled || c.value,
                    onClick: (ye) => !R.disabled && J(e.issue.number, "issue", R.id)
                  }, K(R.label || R.id), 9, nf),
                  R.disabled && R.reason ? (j(), N("span", of, K(R.reason), 1)) : pe("", !0)
                ]))), 128))
              ])
            ])) : pe("", !0),
            (he = e.issue.pullRequest) != null && he.url ? (j(), N("div", rf, [
              A[12] || (A[12] = h("div", { class: "cfw-is-section-label" }, "Pull request", -1)),
              h("a", {
                class: "cfw-is-pr-link",
                href: e.issue.pullRequest.url,
                target: "_blank",
                rel: "noopener noreferrer"
              }, "PR #" + K(e.issue.pullRequest.number) + " · " + K((e.issue.pullRequest.state || "").toLowerCase()) + K(e.issue.pullRequest.isDraft ? " · draft" : ""), 9, lf),
              $.value.length ? (j(), N("div", cf, [
                (j(!0), N(le, null, Re($.value, (R) => (j(), N("div", {
                  key: R.id
                }, [
                  h("button", {
                    class: "cfw-is-action-btn",
                    disabled: R.disabled || c.value,
                    onClick: (ye) => !R.disabled && J(e.issue.number, "pull_request", R.id)
                  }, K(R.label || R.id), 9, ff),
                  R.disabled && R.reason ? (j(), N("span", af, K(R.reason), 1)) : pe("", !0)
                ]))), 128))
              ])) : pe("", !0)
            ])) : pe("", !0),
            u.value ? (j(), N("div", uf, K(u.value), 1)) : pe("", !0),
            h("button", {
              class: "cfw-mbs-close",
              onClick: A[8] || (A[8] = (R) => I.$emit("close"))
            }, "Close")
          ])) : e.filterMode ? (j(), N("div", df, [
            h("div", pf, [
              A[13] || (A[13] = h("div", { class: "cfw-fs-label" }, "View", -1)),
              h("div", hf, [
                (j(!0), N(le, null, Re(b($c), ([R, ye]) => (j(), N("button", {
                  key: R,
                  class: se(["cfw-fs-pill", { active: b(i).listView === R }]),
                  onClick: (q) => {
                    b(i).listView = R, b(o)(), I.$emit("filter-changed");
                  }
                }, K(ye), 11, mf))), 128))
              ])
            ]),
            h("div", gf, [
              A[14] || (A[14] = h("div", { class: "cfw-fs-label" }, "Sort", -1)),
              h("div", bf, [
                (j(!0), N(le, null, Re(b(Dc), ([R, ye]) => (j(), N("button", {
                  key: R,
                  class: se(["cfw-fs-pill", { active: b(i).listSort === R }]),
                  onClick: (q) => {
                    b(i).listSort = R, b(o)(), I.$emit("filter-changed");
                  }
                }, K(ye), 11, wf))), 128))
              ])
            ]),
            h("div", xf, [
              A[15] || (A[15] = h("div", { class: "cfw-fs-label" }, "Status", -1)),
              h("div", vf, [
                (j(!0), N(le, null, Re(b(jc), ([R, ye]) => (j(), N("button", {
                  key: R,
                  class: se(["cfw-fs-chip", { active: b(i).listStatusFilter.includes(R) }]),
                  onClick: (q) => fe(R)
                }, K(ye), 11, yf))), 128))
              ])
            ]),
            ...
            h("button", {
              class: "cfw-mbs-close",
              onClick: A[9] || (A[9] = (R) => I.$emit("close"))
            }, "Done")
          ])) : pe("", !0)
        ], 2)
      ], 64);
...
}), Sf = { class: "cfw-tab-body" }, Cf = { class: "cfw-m-settings" }, kf = {
  id: "cfw-m-token-status",
  class: "cfw-m-settings-token"
}, Tf = {
  class: "cfw-m-hand-toggle",
  style: { "margin-bottom": "8px" }
}, Af = { class: "cfw-m-hand-toggle" }, Ef = { class: "cfw-m-hand-toggle" }, Pf = { class: "cfw-m-swipe-settings" }, Of = { class: "cfw-m-swipe-row" }, If = ["value"], Mf = { class: "cfw-m-swipe-row" }, Rf = ["value"], $f = { class: "cfw-m-swipe-row" }, Df = ["value"], jf = { class: "cfw-m-swipe-row" }, Ff = ["value"], Lf = /* @__PURE__ */ xt({
  __name: "SettingsPane",
  emits: ["handedness", "token-changed"],
  setup(e, { emit: t }) {
    const s = t, n = Je(), { persist: i } = at(), { readToken: o, writeToken: r, promptToken: l } = Yt(), { onPanelTouchStart: c, onPanelTouchEnd: u } = jo(), a = be(() => {
      const P = n.adminToken;
      return P ? "Token is set: " + P.slice(0, 3) + "…" : "No token set.";
    });
    function p() {
      l(), s("token-changed");
    }
    function _() {
      window.confirm("Clear saved admin token?") && (r(""), s("token-changed"));
    }
    const C = [
    ...
    return (P, m) => (j(), N("div", {
      id: "cfw-mv-settings",
      class: se(["cfw-mv", { active: b(n).mobileTab === "settings" }])
    }, [
      h("div", {
      ...
      h("div", Sf, [
        h("div", Cf, [
          ...
          h("div", Tf, [
            h("button", {
              class: se(["cfw-m-hand-btn", { active: b(n).mode === "technical_issue" }]),
              onClick: m[2] || (m[2] = (T) => {
                b(n).mode = "technical_issue", b(i)();
              })
            }, "Issue", 2),
            h("button", {
              class: se(["cfw-m-hand-btn", { active: b(n).mode === "personal_todo" }]),
              onClick: m[3] || (m[3] = (T) => {
                b(n).mode = "personal_todo", b(i)();
              })
            }, "Todo", 2),
            h("button", {
              class: se(["cfw-m-hand-btn", { active: b(n).mode === "feature_request" }]),
              onClick: m[4] || (m[4] = (T) => {
                b(n).mode = "feature_request", b(i)();
              })
            }, "Feature", 2)
          ]),
          ...
          h("div", Af, [
            h("button", {
              class: se(["cfw-m-hand-btn", { active: b(n).handedness === "left" }]),
              onClick: m[5] || (m[5] = (T) => P.$emit("handedness", "left"))
            }, "◀ Left", 2),
            h("button", {
              class: se(["cfw-m-hand-btn", { active: b(n).handedness === "right" }]),
              onClick: m[6] || (m[6] = (T) => P.$emit("handedness", "right"))
            }, "Right ▶", 2)
          ]),
          ...
          h("div", Ef, [
            h("button", {
              class: se(["cfw-m-hand-btn", { active: b(n).panelSnap === "top" }]),
              type: "button",
              onClick: m[7] || (m[7] = (T) => {
                b(n).panelSnap = "top", b(i)();
              })
            }, "▲ Top", 2),
            h("button", {
              class: se(["cfw-m-hand-btn", { active: b(n).panelSnap === "middle" }]),
              type: "button",
              onClick: m[8] || (m[8] = (T) => {
                b(n).panelSnap = "middle", b(i)();
              })
            }, "Middle", 2),
            h("button", {
              class: se(["cfw-m-hand-btn", { active: b(n).panelSnap === "bottom" }]),
              type: "button",
              onClick: m[9] || (m[9] = (T) => {
                b(n).panelSnap = "bottom", b(i)();
              })
            }, "Bottom ▼", 2)
          ]),
          ...
          h("div", Pf, [
            h("div", Of, [
              ...
              $e(h("select", {
                "onUpdate:modelValue": m[10] || (m[10] = (T) => b(n).swipeMapping.shortRight = T),
                class: "cfw-select",
                onChange: m[11] || (m[11] = (T) => b(i)())
              }, [
                (j(), N(le, null, Re(C, (T) => h("option", {
                  key: T.value,
                  value: T.value
                }, K(T.label), 9, If)), 64))
              ], 544), [
                [us, b(n).swipeMapping.shortRight]
              ])
            ]),
            h("div", Mf, [
              m[20] || (m[20] = h("label", null, "Long Right (→→)", -1)),
              $e(h("select", {
                "onUpdate:modelValue": m[12] || (m[12] = (T) => b(n).swipeMapping.longRight = T),
                class: "cfw-select",
                onChange: m[13] || (m[13] = (T) => b(i)())
              }, [
                (j(), N(le, null, Re(C, (T) => h("option", {
                  key: T.value,
                  value: T.value
                ...
                [us, b(n).swipeMapping.longRight]
              ])
            ]),
            h("div", $f, [
              m[21] || (m[21] = h("label", null, "Short Left (←)", -1)),
              $e(h("select", {
                "onUpdate:modelValue": m[14] || (m[14] = (T) => b(n).swipeMapping.shortLeft = T),
                class: "cfw-select",
                onChange: m[15] || (m[15] = (T) => b(i)())
              }, [
                (j(), N(le, null, Re(C, (T) => h("option", {
                  key: T.value,
                  value: T.value
                ...
                [us, b(n).swipeMapping.shortLeft]
              ])
            ]),
            h("div", jf, [
              m[22] || (m[22] = h("label", null, "Long Left (←←)", -1)),
              $e(h("select", {
                "onUpdate:modelValue": m[16] || (m[16] = (T) => b(n).swipeMapping.longLeft = T),
                class: "cfw-select",
                onChange: m[17] || (m[17] = (T) => b(i)())
              }, [
                (j(), N(le, null, Re(C, (T) => h("option", {
                  key: T.value,
                  value: T.value
...
}), Nf = { class: "cfw-compose-header" }, Vf = { class: "cfw-compose-title" }, Hf = {
  key: 0,
  class: "cfw-compose-context"
}, zf = { class: "cfw-compose-context-quote" }, Uf = { class: "cfw-compose-body" }, Kf = {
  class: "cfw-textarea-wrap",
  style: { flex: "1", padding: "14px" }
}, Wf = ["placeholder", "onKeydown"], Bf = {
  ...
  setup(e, { emit: t }) {
    const s = e, n = t, i = Je(), { submitComment: o, createLinkedItem: r } = Et(), l = /* @__PURE__ */ U(null), c = be(() => !!i.draftDescription.trim());
    Tt(() => s.open, (a) => {
      a && (i.draftDescription = "", Mt(() => {
        var p;
    ...
    async function u() {
      ...
      const a = i.draftDescription.trim();
      if (!a) {
      ...
      try {
        if (s.mode === "comment")
          await o(s.issue.number, a);
        else {
          const p = a.split(`
`)[0], _ = p.length > 50 ? p.slice(0, 50) + "..." : p;
          await r(s.issue.number, _, a, !1);
        }
    ...
    return (a, p) => (j(), N(le, null, [
      h("div", {
        id: "cfw-compose-overlay",
        class: se({ active: e.open }),
        onClick: p[0] || (p[0] = (_) => a.$emit("close"))
      }, null, 2),
      h("div", {
        ...
        h("div", Nf, [
          h("span", Vf, K(e.mode === "comment" ? "New Comment" : "Create Linked Item"), 1),
          h("button", {
            class: "cfw-compose-close",
            onClick: p[1] || (p[1] = (_) => a.$emit("close"))
          }, "×")
        ]),
        e.issue ? (j(), N("div", Hf, [
          h("div", zf, [
            h("strong", null, "#" + K(e.issue.number), 1),
            It(" " + K(e.issue.title), 1)
          ])
        ])) : pe("", !0),
        h("div", Uf, [
          h("div", Kf, [
            $e(h("textarea", {
              ref_key: "descRef",
              ref: l,
              "onUpdate:modelValue": p[2] || (p[2] = (_) => b(i).draftDescription = _),
          ...
          h("div", Bf, [
            h("button", {
              class: "cfw-btn cfw-btn-outline",
              onClick: p[3] || (p[3] = (_) => a.$emit("close"))
            }, "Cancel"),
            h("button", {
              class: "cfw-btn cfw-btn-primary",
              disabled: !c.value,
              onClick: u
            }, K(b(i).creating ? "Submitting..." : "Submit"), 9, qf)
          ])
        ])
      ], 2)
    ], 64));
  }
}), Jf = { class: "cfw-tab-body" }, Gf = {
  key: 0,
  id: "cfw-mv-text-form",
  class: "cfw-mf"
}, Xf = { id: "cfw-mobile-nav" }, Qf = /* @__PURE__ */ xt({
  __name: "MobileWidget",
  setup(e, { expose: t }) {
    const s = Je(), { persist: n } = at(), { onPanelTouchStart: i, onPanelTouchEnd: o } = jo(), { loadIssues: r } = Et(), { readToken: l } = Yt(), c = _c(), u = Sc(), a = kc(), p = /* @__PURE__ */ U(null), _ = be(() => ({
      display: "flex",
      flexDirection: "column"
    }));
    function C(q) {
      s.mobileTab = q, q === "list" && r(!1), q === "text" && Mt(() => {
        var x;
        return (x = p.value) == null ? void 0 : x.focusTitle();
      }), n();
    }
    const P = /* @__PURE__ */ U(!1), m = /* @__PURE__ */ U("comment"), T = /* @__PURE__ */ U(null);
    function G(q, x) {
      m.value = q, T.value = x, P.value = !0, A(3);
    }
    async function B(q, x) {
      if (q !== "none") {
        if (q === "mark_viewed") {
          s.itemViews[x.number] = Date.now(), n();
          return;
        }
        ...
        try {
          await Et().executeAction(x.number, q, "issue"), await r(!0);
        } catch (D) {
    ...
    function I(q = !1) {
      var x;
      if (P.value = !1, u.close(), a.close(), !q) {
        const D = ((x = window.history.state) == null ? void 0 : x.widgetDepth) || 0;
        D > 0 && history.go(-D);
      }
    }
    function A(q) {
      var D;
      (((D = window.history.state) == null ? void 0 : D.widgetDepth) || 0) < q && history.pushState({ widgetDepth: q }, "");
    }
    function ce(q) {
      var D;
      q === 3 ? P.value = !1 : q === 2 ? u.close() : q === 1 && I(!1);
      const x = ((D = window.history.state) == null ? void 0 : D.widgetDepth) || 0;
      x >= q && history.go(-(x - q + 1));
    }
    function he() {
    ...
    function R(q) {
      var D;
      const x = ((D = window.history.state) == null ? void 0 : D.widgetDepth) || 0;
      x < 3 && P.value && (P.value = !1), x < 2 && u.sheetOpen.value && u.close(), x < 1 && a.isOpen.value && a.close();
    }
    Pn(() => {
      c.stopUndoCountdown(), window.removeEventListener("popstate", R);
    }), he();
    function ye(q) {
      if (!l() && (Yt().promptToken(), !l()))
        return;
      const x = typeof q == "string" ? parseInt(q, 10) : q;
      a.isOpen.value || (a.open(), A(1)), C("list");
      const D = s.issues.find((F) => F.number === x);
      D ? $(D) : Et().loadIssues(!0).then(() => {
        const F = s.issues.find((Ge) => Ge.number === x);
        F && $(F);
      });
    }
    return t({ openItem: ye }), (q, x) => {
      const D = Qr("IssuesList");
      return j(), N(le, null, [
        $e(h("button", {
          id: "cfw-mobile-launcher",
          type: "button",
          "aria-label": "Open feedback widget",
          class: se({ "panel-left": b(s).handedness === "left" }),
          onTouchstartPassive: x[0] || (x[0] = //@ts-ignore
          (...F) => b(a).onTouchStart && b(a).onTouchStart(...F)),
          onTouchend: x[1] || (x[1] = //@ts-ignore
          (...F) => b(a).onTouchEnd && b(a).onTouchEnd(...F)),
          onClick: x[2] || (x[2] = (F) => fe())
        }, [...x[18] || (x[18] = [
          h("svg", {
        ...
        h("div", {
          id: "cfw-swipe-hint",
          class: se({ visible: b(a).swipeHintVisible.value }),
          style: Jt(b(a).swipeHintStyle.value)
        }, "← swipe →", 6),
        $e(h("div", {
          id: "cfw-desktop-backdrop",
          onClick: x[3] || (x[3] = (F) => I(!1))
        }, null, 512), [
          [en, b(a).isOpen.value]
        ]),
        $e(h("div", {
          ...
          h("div", {
            id: "cfw-mobile-body",
            class: se({ "snap-bottom": b(s).panelSnap === "bottom", "snap-top": b(s).panelSnap === "top", "snap-middle": b(s).panelSnap === "middle" })
          }, [
            h("div", {
              id: "cfw-mv-text",
              class: se(["cfw-mv", { active: b(s).mobileTab === "text" }])
            }, [
              h("div", {
                class: "cfw-panel-handle",
                onTouchstartPassive: x[4] || (x[4] = //@ts-ignore
                (...F) => b(i) && b(i)(...F)),
                onTouchend: x[5] || (x[5] = //@ts-ignore
                (...F) => b(o) && b(o)(...F))
              }, [...x[19] || (x[19] = [
                h("div", { class: "cfw-panel-handle-bar" }, null, -1)
              ])], 32),
              h("div", Jf, [
                b(s).textCreateSuccess ? (j(), N("div", {
                  key: 1,
                  id: "cfw-mv-text-success",
                  class: "cfw-m-success",
                  onClick: x[7] || (x[7] = (F) => b(c).reset())
                }, [
                  x[20] || (x[20] = h("div", { class: "cfw-m-success-ring" }, [
                    h("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                      fill: "none",
                      viewBox: "0 0 24 24",
                  ...
                  x[21] || (x[21] = h("div", { class: "cfw-m-success-hint" }, "Tap to submit another", -1)),
                  b(c).undoSecondsLeft.value > 0 && b(s).lastSubmissionId ? (j(), N("button", {
                    key: 0,
                    id: "cfw-mv-text-undo",
                    class: "cfw-m-undo-btn",
                    onClick: x[6] || (x[6] = ts((F) => b(c).undo(), ["stop"]))
                  }, "Undo (" + K(b(c).undoSecondsLeft.value) + ")", 1)) : pe("", !0)
                ])) : (j(), N("div", Gf, [
                  Ce(Rc, {
                    ref_key: "textFormRef",
                    ref: p,
            ...
            Ce(D, {
              onRefresh: x[8] || (x[8] = (F) => b(r)(!0)),
              onOpenIssue: $,
              onOpenFilter: J,
              onSwipeAction: B
            }),
            Ce(Lf, {
              onHandedness: b(a).applyHandedness,
              onTokenChanged: Y
            }, null, 8, ["onHandedness"])
          ], 2),
          h("nav", Xf, [
            b(s).handedness === "left" ? (j(), N("button", {
              key: 0,
              class: "cfw-nav-btn",
              type: "button",
              onClick: x[9] || (x[9] = (F) => I(!1))
            }, [...x[22] || (x[22] = [
              h("svg", {
                xmlns: "http://www.w3.org/2000/svg",
                fill: "none",
            ...
            h("button", {
              id: "cfw-nav-text",
              class: se(["cfw-nav-btn", { active: b(s).mobileTab === "text" }]),
              type: "button",
              onClick: x[10] || (x[10] = (F) => C("text"))
            }, [...x[23] || (x[23] = [
              h("svg", {
                xmlns: "http://www.w3.org/2000/svg",
                fill: "none",
            ...
            h("button", {
              id: "cfw-nav-list",
              class: se(["cfw-nav-btn", { active: b(s).mobileTab === "list" }]),
              type: "button",
              onClick: x[11] || (x[11] = (F) => C("list"))
            }, [...x[24] || (x[24] = [
              h("svg", {
                xmlns: "http://www.w3.org/2000/svg",
                fill: "none",
            ...
            h("button", {
              id: "cfw-nav-settings",
              class: se(["cfw-nav-btn", { active: b(s).mobileTab === "settings" }]),
              type: "button",
              onClick: x[12] || (x[12] = (F) => C("settings"))
            }, [...x[25] || (x[25] = [
              h("svg", {
                xmlns: "http://www.w3.org/2000/svg",
                fill: "none",
        ...
        Ce(_f, {
          open: b(u).sheetOpen.value,
          issue: b(u).sheetIssue.value,
          "filter-mode": b(u).filterMode.value,
          "edit-mode": b(u).editMode.value,
          onClose: x[14] || (x[14] = (F) => ce(2)),
          onCancelEdit: x[15] || (x[15] = (F) => b(u).editMode.value = !1),
          onFilterChanged: x[16] || (x[16] = (F) => b(r)(!0)),
          onComposeSheet: G,
          onEditIssue: X
  ...
  setup(e, { expose: t }) {
    const s = e, n = Je(), { restore: i } = at(), { readToken: o } = Yt(), r = /* @__PURE__ */ U(null);
    return t({
      openItem(l) {
